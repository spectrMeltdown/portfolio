class Project  {
  ...
  public get getTech(): Array<string> {
    return this.tech;
  }
  ...
  public set updateTech(v: Array<string>) {
    this.tech = v;
  }

  constructor(name: string, description: string, tech: Array<string>) {
    this.name = name;
